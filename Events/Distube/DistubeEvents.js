...
client.distube
    ...
    .setDescription(`${thumbsup} **|** Playing \`${song.name}\` - \`${song.formattedDuration}\`\n${setting} **|** ${status(queue)}\n${human} **|** Requested by: ${song.user}`)
    .setColor("BLURPLE")
    .setFooter("▶")
    .setTimestamp() ] }))
    ...
    .setDescription(`${thumbsup} **|** Added \`${song.name}\` - \`${song.formattedDuration}\`\n${human} **|** To the queue by ${song.user}`)
    .setColor("BLURPLE")
    .setFooter("➕")
    .setTimestamp() ] }))
    ...
    .setDescription(`${thumbsup} **|* Added \`${playlist.name}\`\n${setting} **|** To the queue\n${status(queue)}`)
    .setColor("BLURPLE")
    .setFooter("➕")
    .setTimestamp()]}))
