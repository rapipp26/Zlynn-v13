...
module.exports = {
  ...
  options: [{
    ...
    async execute(interaction, client) {
      ...
      .setDescription(`${client.emojis.false1} **|** *This word is already in the blacklisted word list*`)
      .setColor("RED")
      const embed2 = new MessageEmbed()
      .setDescription(`${client.emojis.true1} **|** *Successfully added \`${word}\` to the blacklisted word list*`)
      .setColor("GREEN")
      const embed3 = new MessageEmbed()
      .setDescription(`${client.emojis.false1} **|** *This word is not in the blacklisted word list*`)
      .setColor("RED")
      const embed4 = new MessageEmbed()
      .setDescription(`${client.emojis.true1} **|** *Successfully removed \`${word}\` from the blacklisted word list*`)
      .setColor("GREEN")
