...
module.exports = { 
    ...
    phin(`https://some-random-api.ml/canvas/youtube-comment?avatar=${interaction.user.displayAvatarURL()}&username=${interaction.user.username}&comment=${comment}`).then(res => {
